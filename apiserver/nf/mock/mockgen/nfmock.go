...
// Package mock_nf_proto is a generated GoMock package.
package mockgen
...
import (
	...
	nf_proto "notificationService/apiserver/nf/proto"
	reflect "reflect"
)

// MockNotificationClient is a mockgen of NotificationClient interface
type MockNotificationClient struct {
	ctrl     *gomock.Controller
	recorder *MockNotificationClientMockRecorder
}

// MockNotificationClientMockRecorder is the mockgen recorder for MockNotificationClient
type MockNotificationClientMockRecorder struct {
	mock *MockNotificationClient
}

// NewMockNotificationClient creates a new mockgen instance
...
func (m *MockNotificationClient) SayHello(ctx context.Context, in *nf_proto.HelloRequest, opts ...grpc.CallOption) (*nf_proto.HelloReply, error) {
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "SayHello", varargs...)
	ret0, _ := ret[0].(*nf_proto.HelloReply)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockNotificationClient) CreateNfWUserFilter(ctx context.Context, in *nf_proto.CreateNfWUserFilterRequest, opts ...grpc.CallOption) (*nf_proto.CreateNfResponse, error) {
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "CreateNfWUserFilter", varargs...)
	ret0, _ := ret[0].(*nf_proto.CreateNfResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockNotificationClient) CreateNfWAppFilter(ctx context.Context, in *nf_proto.CreateNfWAppFilterRequest, opts ...grpc.CallOption) (*nf_proto.CreateNfResponse, error) {
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
...
func (m *MockNotificationClient) CreateNfWaddrs(ctx context.Context, in *nf_proto.CreateNfWaddrsRequest, opts ...grpc.CallOption) (*nf_proto.CreateNfResponse, error) {
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
...
func (m *MockNotificationClient) DescribeNfs(ctx context.Context, in *nf_proto.DescribeNfsRequest, opts ...grpc.CallOption) (*nf_proto.DescribeNfsResponse, error) {
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "DescribeNfs", varargs...)
	ret0, _ := ret[0].(*nf_proto.DescribeNfsResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockNotificationClient) DescribeUserNfs(ctx context.Context, in *nf_proto.DescribeNfsRequest, opts ...grpc.CallOption) (*nf_proto.DescribeNfsResponse, error) {
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
...
// MockNotificationServer is a mockgen of NotificationServer interface
type MockNotificationServer struct {
	ctrl     *gomock.Controller
	recorder *MockNotificationServerMockRecorder
}

// MockNotificationServerMockRecorder is the mockgen recorder for MockNotificationServer
type MockNotificationServerMockRecorder struct {
	mock *MockNotificationServer
}

// NewMockNotificationServer creates a new mockgen instance
...
// SayHello mocks base method
func (m *MockNotificationServer) SayHello(arg0 context.Context, arg1 *nf_proto.HelloRequest) (*nf_proto.HelloReply, error) {
...
// CreateNfWUserFilter mocks base method
func (m *MockNotificationServer) CreateNfWUserFilter(arg0 context.Context, arg1 *nf_proto.CreateNfWUserFilterRequest) (*nf_proto.CreateNfResponse, error) {
...
// CreateNfWAppFilter mocks base method
func (m *MockNotificationServer) CreateNfWAppFilter(arg0 context.Context, arg1 *nf_proto.CreateNfWAppFilterRequest) (*nf_proto.CreateNfResponse, error) {
...
// CreateNfWaddrs mocks base method
func (m *MockNotificationServer) CreateNfWaddrs(arg0 context.Context, arg1 *nf_proto.CreateNfWaddrsRequest) (*nf_proto.CreateNfResponse, error) {
...
// DescribeNfs mocks base method
func (m *MockNotificationServer) DescribeNfs(arg0 context.Context, arg1 *nf_proto.DescribeNfsRequest) (*nf_proto.DescribeNfsResponse, error) {
...
// DescribeUserNfs mocks base method
func (m *MockNotificationServer) DescribeUserNfs(arg0 context.Context, arg1 *nf_proto.DescribeNfsRequest) (*nf_proto.DescribeNfsResponse, error) {
